 ...
 *         support jobs and saves you a lot of leg work. This example uses a
 *         memory-based database (provided by @EnableBatchProcessing), meaning
 *         that when it’s done, the data is gone.
 */
@Configuration
...
public class BatchConfiguration {
	...
	public FlatFileItemReader<Person> reader() {
		return new FlatFileItemReaderBuilder<Person>().name("personItemReader")
				.resource(new ClassPathResource("sample-data.csv")).delimited().names(fieldNames())
