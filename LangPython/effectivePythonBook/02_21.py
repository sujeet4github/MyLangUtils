# https://raw.githubusercontent.com/bslatkin/effectivepython/master/example_code/item_21.py
...
# Example 7
# * is a python 3 feature, all arguments after * are keyword only
...
try:
    ...
    logging.exception('Expected: needs keyword for the last 2 arguments')
else:
    assert False
