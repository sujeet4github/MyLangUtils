...
Even though we can implement the pattern by ourselves, the Ruby standard library has a prebuilt module that let us make any of our objects observable, freeing us from defining the same methods everywhere.

Final version refactored to use ruby library: Observable
03-O-Employee.rb
